...
export default function TugOfWarBar({
  ...
  const label =
    heat > MOMENTUM.TAKEOVER_THRESHOLD
      ? "TAKEOVER"
    ...
    <View style={{ paddingHorizontal: 20, paddingBottom: 4 }}>
      <View
        style={{
          ...
          shadowColor:
            heat > MOMENTUM.SURGE_THRESHOLD ? dominantColor : "transparent",
      ...
      >
        ...
        <Animated.View
          style={{
            ...
            left: 0,
            width: leftWidth,
            backgroundColor: teamA.color + "55",
          }}
        />
        ...
        <Animated.View
          style={{
            ...
            right: 0,
            width: rightWidth,
            backgroundColor: teamB.color + "55",
          }}
        />
          ...
          >
            <Text
              style={{
                ...
                fontSize: 12,
                color:
                  matchStatus === "finished" ? theme.textMute : theme.warning,
                letterSpacing: 1.5,
              }}
            >
      ...
      >
        ...
        <Text
          style={{
            ...
            fontSize: 9,
            color:
              heat > MOMENTUM.SURGE_THRESHOLD ? dominantColor : theme.textMute,
            letterSpacing: 0.6,
          }}
        >
          {label}
